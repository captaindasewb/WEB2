        ...
        <div class="container col-md-3 my-4">
            <form class="row g-3" action="scripts/signup_script.php" method="POST">
                ...
                <div class="col-md-12">
                    ...
                    <input type="tel" name="mobile" class="form-control" id="mobile" pattern="[0-9]{10}" maxlength="10" minlength="10" title="Số điện thoại phải đúng 10 chữ số" required placeholder="VD: 0901234567">
                </div>
                <div class="col-md-12">
